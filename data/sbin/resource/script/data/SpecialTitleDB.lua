local Items = {
	...
	{q_id = 57,q_lv = 71,q_exp = 5,q_school = 1,q_name = '陆地真仙-战',q_color = 'red',},
	{q_id = 58,q_lv = 80,q_exp = 5,q_school = 1,q_name = '位列仙班-战',q_color = 'red',},
	{q_id = 59,q_lv = 90,q_exp = 5,q_school = 1,q_name = '九天之上-战',q_color = 'red',},
	{q_id = 60,q_lv = 100,q_exp = 5,q_school = 1,q_name = '主宰-战',q_color = 'red',},
	...
	{q_id = 127,q_lv = 71,q_exp = 5,q_school = 2,q_name = '陆地真仙-法',q_color = 'red',},
	{q_id = 128,q_lv = 80,q_exp = 5,q_school = 2,q_name = '位列仙班-法',q_color = 'red',},
	{q_id = 129,q_lv = 90,q_exp = 5,q_school = 2,q_name = '九天之上-法',q_color = 'red',},
	{q_id = 130,q_lv = 100,q_exp = 5,q_school = 2,q_name = '主宰-法',q_color = 'red',},
	...
	{q_id = 197,q_lv = 71,q_exp = 5,q_school = 3,q_name = '陆地真仙-道',q_color = 'red',},
	{q_id = 198,q_lv = 80,q_exp = 5,q_school = 3,q_name = '位列仙班-道',q_color = 'red',},
	{q_id = 199,q_lv = 90,q_exp = 5,q_school = 3,q_name = '九天之上-道',q_color = 'red',},
	{q_id = 200,q_lv = 100,q_exp = 5,q_school = 3,q_name = '主宰-道',q_color = 'red',},
};
return Items
