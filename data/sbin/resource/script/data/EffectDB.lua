local Items = {
    ...
    {q_id = 12038,q_effectType = 12,dropID = 910,},
    ...
    {q_id = 6011,q_effectType = 12,dropID = 910,},
    ...
    --新增技能书
    {q_id = 70001,q_effectType = 5,q_skillLvl = 1052001,},
    {q_id = 70002,q_effectType = 5,q_skillLvl = 2052001,},
    {q_id = 70003,q_effectType = 5,q_skillLvl = 3052001,},

    --{q_id = 70004,q_effectType = 5,q_skillLvl = 1054001,},
    --{q_id = 70005,q_effectType = 5,q_skillLvl = 2054001,},
    --{q_id = 70006,q_effectType = 5,q_skillLvl = 3054001,},
	{q_id = 7140,q_effectType = 5,q_skillLvl = 1054001,},	--元神战神战	
	{q_id = 7141,q_effectType = 5,q_skillLvl = 1055001,},	--元神法神
	{q_id = 7142,q_effectType = 5,q_skillLvl = 1056001,},	--元神道神

	{q_id = 7143,q_effectType = 5,q_skillLvl = 2054001,},	--元神战神法
	{q_id = 7144,q_effectType = 5,q_skillLvl = 2055001,},	--元神法神
	{q_id = 7145,q_effectType = 5,q_skillLvl = 2056001,},	--元神战神

	{q_id = 7146,q_effectType = 5,q_skillLvl = 3054001,},	--元神战神道	
	{q_id = 7147,q_effectType = 5,q_skillLvl = 3055001,},	--元神法神
	{q_id = 7148,q_effectType = 5,q_skillLvl = 3056001,},	--元神道神
    ...
    --回城
    {q_id = 1020,q_effectType = 2,q_mapID = 2100,q_xPos = 124,q_yPos = 134,},

    --经验丹
    {q_id = 1023,q_effectType = 1,q_effect_attr = 1,q_drug = 50000,},
    {q_id = 1024,q_effectType = 1,q_effect_attr = 1,q_drug = 100000,},
    {q_id = 1025,q_effectType = 1,q_effect_attr = 1,q_drug = 200000,},

    --卷轴
    {q_id = 1026,q_effectType = 2,q_mapID = 8000,q_xPos = 122,q_yPos = 181,}, --金币
    {q_id = 1027,q_effectType = 2,q_mapID = 8001,q_xPos = 127,q_yPos = 72,},  --经验
    {q_id = 1028,q_effectType = 2,q_mapID = 8002,q_xPos = 53,q_yPos = 40,},   --绑元
	{q_id = 1029,q_effectType = 2,q_mapID = 8003,q_xPos = 64,q_yPos = 53,},   --铁矿
    ...
    --增加坐骑效果 九   零 一 起玩   w ww . 9 01 7 5.com
    {q_id = 13150,q_effectType = 99,},
	
	{q_id = 28000,q_effectType = 4,q_mapID = 6004,q_xPos = 1,},
	{q_id = 28001,q_effectType = 4,q_mapID = 6005,q_xPos = 1,},
	{q_id = 28002,q_effectType = 4,q_mapID = 6006,q_xPos = 1,},
	{q_id = 28003,q_effectType = 4,q_mapID = 6007,q_xPos = 1,},
	{q_id = 28004,q_effectType = 4,q_mapID = 6100,q_xPos = 1,},
	{q_id = 28005,q_effectType = 4,q_mapID = 6101,q_xPos = 1,},
	{q_id = 28006,q_effectType = 4,q_mapID = 6102,q_xPos = 1,},
	{q_id = 28007,q_effectType = 4,q_mapID = 888888,q_xPos = 1,},
