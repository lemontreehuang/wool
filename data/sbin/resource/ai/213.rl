;战士V道士
;金刚护体:1008	烈火剑法:1006	野蛮冲撞:1005	突斩:1010	刺杀剑术:1003	破盾斩:1009
...
*									Event(=CASTING)											IsEventFrom(SELF) && CurSkill(!=1000)									CurSkill(->1000)
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(1008) && TriggerDiff(>=10000)								Cast(TARGET_SELECT_SELF, 1008)
State(=Fight)						Event(=SKILLDISTTOOFAR)									IsSkillReady(1005) && TriggerDiff(>=10000)								Cast(TARGET_SELECT_THREATLIST_FIRST, 1005)
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(1010) && TriggerDiff(>=10000)								CurSkill(->1010)
