;法师元神6级 蟠龙套  技能：2001 小火球  2002 雷电术  2003地狱雷光  2004魔法盾  2005抗拒火环  2007火墙  2008冰咆哮 2009风影盾  2010狂龙紫电
;Preset								Trigger													Condition																																				Exec
;-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
State(=Idle)						Event(=BORN)											*																																		SetSkillList(2001,2002,2003,2004,2005,2007,2008,2009,2010) && CurSkill(->2010) && MoveSpeed(->100)
...
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(2008)  && TriggerDiff(>=2000)																								CurSkill(->2008)
