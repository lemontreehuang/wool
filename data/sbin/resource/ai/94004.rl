;法师元神5级 魔雷套  技能：2001 小火球  2002 雷电术  2003地狱雷光  2004魔法盾  2005抗拒火环  2007火墙  2008冰咆哮
;Preset								Trigger													Condition																																Exec
;-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
State(=Idle)						Event(=BORN)											*																																		SetSkillList(2001,2002,2003,2004,2005,2007,2008) && CurSkill(->2002) && MoveSpeed(->100)
