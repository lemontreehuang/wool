;道士元神7级 圣天套  技能：3001集体隐身  3002灵魂道符 3003群体治愈 3004施毒术  3008骷髅召唤 3006神圣战甲  3007召唤神兽    3009狮子吼  3010斗转星移  3011幽冥火咒  3012强化骷髅  3303强化施毒
;Preset								Trigger													Condition												Exec
;---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
State(=Idle)						Event(=BORN)											*														SetSkillList(1001,3002,3003,3004,3008,3006,3007,3009,3010,3011,3303) && CurSkill(->3011) && MoveSpeed(->5)
...
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(3010) && TriggerDiff(>=10000)								Cast(TARGET_SELECT_SELF, 3010)
...
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(3009)														CurSkill(->3009)
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(3011)														CurSkill(->3011)
State(=Fight)						Event(=SKILLREADY)										IsSkillReady(3303)														CurSkill(->3303)