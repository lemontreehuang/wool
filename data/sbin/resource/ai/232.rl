...
State(=Fight)						*														HasSceneBuff(SELF,2011) && TriggerDiff(>=15000)												Cast(TARGET_SELECT_SELF, 3003) && MoveTo(RANDOM_POINT5)
State(=Fight)						*														HasSceneBuff(SELF,2007) && TriggerDiff(>=15000)												Cast(TARGET_SELECT_SELF, 3003) && MoveTo(RANDOM_POINT5)
