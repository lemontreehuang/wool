;道士元神2级 天尊套  技能：3001集体隐身  3002灵魂道符 3003群体治愈 3004施毒术  3006神圣战甲  3007召唤神兽  3008骷髅召唤  3009狮子吼  3010斗转星移  3011幽冥火咒  3012强化骷髅  3303强化施毒
;Preset								Trigger													Condition												Exec
;---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
State(=Idle)						Event(=BORN)											*														SetSkillList(1001,3002,3003,3004) && CurSkill(->3002) && MoveSpeed(->5)
